...
respond with a small JSON object that either represents a tool call or a normal
assistant message. This is useful for providers like
[Ollama](https://ollama.com) which do not implement OpenAI‑style tool calling.
...
bridge schema and its limitations.
